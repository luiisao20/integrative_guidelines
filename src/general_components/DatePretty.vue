<template>
    <input @input="inputDate(date)" v-model="date" required type="text" maxlength="10" name="floating_birth_place" id="floating_birth_place"
    ...
    <label v-if="showLabel" for="floating_birth_place" id="hola"
