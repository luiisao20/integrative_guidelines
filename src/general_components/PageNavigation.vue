<template>
    <nav class="flex items-center justify-between pt-4 mb-10" aria-label="Table navigation">
        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Mostrando
            <span class="font-semibold text-gray-900 dark:text-white">
                {{ currentStep * stepTo + 1 }} - {{ currentStep * stepTo + stepTo }}
