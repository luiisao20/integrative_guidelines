    ...
    <table class="text-sm w-full text-gray-500 rounded-xl dark:text-gray-400">
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td colspan="2" class="px-2 py-4 text-center text-black">
                    <div class="flex flex-row justify-center gap-4">
                        <div class="flex flex-row gap-4">
                            <p>Sí</p>
                            <input  v-model="data.dataTable['Características del consultorio'].privacy"
                ...
                <td colspan="2" class="px-2 py-4 text-center text-black">
                    <div class="flex flex-row justify-center gap-4">
                        <div class="flex flex-row gap-4">
                            <p>Sí</p>
                            <input  v-model="data.dataTable['Características del consultorio'].quiet"
            ...
            <tr class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                ...
                <th scope="col" colspan="2" class="px-2 py-3 text-center">
                    Sí <PopOver idPop="1" variant="info" textInfo="Si existen grabaciones de las sesiones, debes llenar los apartados de 'Tipo de grabación' y 'Efecto'"/>
                </th>
                <th scope="col" colspan="2" class="px-2 py-3 text-center">
                    No
                </th>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td colspan="2" class="px-2 py-4 text-center">
                    <input  v-model="data.dataTable['Grabación de las sesiones']"
                        @click="data.dataTable['Tipo de grabación'] = ''; data.dataTable['Efecto Tipo de grabación'] = ''"
            ...
            <tr>
                <th scope="col" colspan="6" class="text-xs font-bold py-4 text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <PopOver idPop="2" variant="info" textInfo="Escoge un tipo de posición o puedes llenar el apartado 'Otro', además es obligatorio el campo 'Efecto'"/>
                </th>
            </tr>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td rowspan="2" class="py-4 px-2 w-[15%] text-black dark:text-white">
                    <div class="relative z-0 mb-2 w-full">
                        <input  v-model="data.dataTable['POSICIÓN ENTRE PACIENTE Y TERAPEURA'].other" @click="data.dataTable['POSICIÓN ENTRE PACIENTE Y TERAPEURA'].selected = ''"
                            name="floating_efect_records" id="floating_efect_records"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-main-default peer"
                            placeholder=" "  />
                        <label for="floating_efect_records"
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <td v-for="(item, index) in content.slice(0, 5)" :key="index" class="px-2 py-4 text-center">
                    <input  v-model="data.dataTable['POSICIÓN ENTRE PACIENTE Y TERAPEURA'].selected" @click="data.dataTable['POSICIÓN ENTRE PACIENTE Y TERAPEURA'].other = ''"
                        :id="`radio-pacient-therapist`" type="radio" :value="`${item}`" :name="`radio-pacient-therapist`" class="w-4 h-4 text-main-default bg-gray-100 border-gray-300 focus:ring-main-default dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                </td>
            </tr>
            <tr>
                <td colspan="6" class="bg-white border-b px-10 py-4 dark:bg-gray-800 dark:border-gray-700 text-center">
                    <div class="relative z-0 mb-2 w-full">
                        <input  v-model="data.dataTable['Efecto POSICIÓN ENTRE PACIENTE Y TERAPEURA']"
                            name="floating_efect_records" id="floating_efect_records"
