                ...
                <tr v-for="(item, index) in content" :key="index"
                    ...
                    <td class="px-6 py-4 text-center">
                        <input @input="showData" v-model="data[`${item.title}.${index}.option`]" 
                            :id="`default-table-radio-${index}`" type="radio" value="Sí" :name="`default-table-${index}`" class="w-4 h-4 text-main-default bg-gray-100 border-gray-300 focus:ring-main-default dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    </td>
                    <td class="px-6 py-4 text-center">
                        <input @input="showData" v-model="data[`${item.title}.${index}.option`]" 
                            :id="`default-table-radio-${index}`" type="radio" value="No" :name="`default-table-${index}`" class="w-4 h-4 text-main-default bg-gray-100 border-gray-300 focus:ring-main-default dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    </td>
                    <td class="px-6 py-4">
